        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-[rgb(187,0,0)] font-bold mt-1">RAISA-HR-026</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="scp-card p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-4 text-center">
              <div className="text-3xl font-bold text-[rgb(187,0,0)] mb-2">{jobPostings.length}</div>
            ...
            {jobPostings.map((job) => (
              <div key={job.id} className="scp-card p-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className={`text-xs font-bold px-3 py-1 ${
                        job.status === 'Urgent' ? 'bg-[rgb(187,0,0)] text-white' :
                    ...
                    <div className="flex items-center gap-4 text-sm text-[rgb(160,160,160)] flex-wrap">
                      <span className="flex items-center gap-1">
                        <span className="text-[rgb(187,0,0)]">◆</span> {job.division}
                      </span>
                      <span className="flex items-center gap-1">
                        <span className="text-[rgb(187,0,0)]">◆</span> Level {job.clearanceLevel} Clearance
                      </span>
                      <span className="flex items-center gap-1">
                        <span className="text-[rgb(187,0,0)]">◆</span> {job.employmentType}
                      </span>
                    </div>
                    <p className="text-xs text-[rgb(187,0,0)] font-bold mt-2">{job.id}</p>
                  </div>
                  <div className="text-right">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {/* Responsibilities */}
                  <div>
                    <h4 className="text-sm font-bold text-[rgb(187,0,0)] mb-2">KEY RESPONSIBILITIES</h4>
                    <ul className="space-y-1">
                      {job.responsibilities.map((resp, index) => (
                        <li key={index} className="text-xs text-[rgb(220,220,220)] flex items-start gap-2">
                          <span className="text-[rgb(187,0,0)] mt-0.5">▸</span>
                          <span>{resp}</span>
                        </li>
                      ))}
                    </ul>
                  ...
                  {/* Requirements */}
                  <div>
                    <h4 className="text-sm font-bold text-[rgb(187,0,0)] mb-2">REQUIREMENTS</h4>
                    ...
                    <h4 className="text-sm font-bold text-[rgb(187,0,0)] mb-2">PREFERRED QUALIFICATIONS</h4>
                    <ul className="space-y-1">
                ...
                <div className="mt-6 pt-4 border-t border-[rgb(100,100,100)]">
                  <button 
                    ...
                    className="bg-[rgb(187,0,0)] hover:bg-[rgb(150,0,0)] text-white font-bold py-3 px-6 text-sm transition-colors"
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="scp-card p-6">
            <h3 className="text-lg font-bold text-[rgb(187,0,0)] mb-4">WHY JOIN RAISA?</h3>
          ...
          <div className="scp-card p-6">
            <h3 className="text-lg font-bold text-[rgb(187,0,0)] mb-4">APPLICATION PROCESS</h3>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <div className="bg-[rgb(187,0,0)] text-white font-bold text-sm w-8 h-8 flex items-center justify-center flex-shrink-0">
                  1
                </div>
                <div>
        ...
        <div className="scp-card p-6 text-center">
          <h3 className="text-lg font-bold text-[rgb(187,0,0)] mb-3">QUESTIONS ABOUT POSITIONS?</h3>
              ...
              {!formSubmitted ? (
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="bg-[rgb(17,17,17)] border border-[rgb(100,100,100)] p-4 mb-6">
                    ...
                    <p className="text-lg font-bold text-[rgb(187,0,0)]">{selectedJob.title}</p>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-xs text-[rgb(160,160,160)] mb-2">
                          EMAIL ADDRESS <span className="text-[rgb(187,0,0)]">*</span>
                        </label>
                        <input
                          type="email"
                          name="email"
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-xs text-[rgb(160,160,160)] mb-2">
                          CURRENT SITE <span className="text-[rgb(187,0,0)]">*</span>
                        </label>
                        <input
                          type="text"
                          name="currentSite"
                      ...
                      <div>
                        <label className="block text-xs text-[rgb(160,160,160)] mb-2">
                          CURRENT DEPARTMENT <span className="text-[rgb(187,0,0)]">*</span>
                        </label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-xs text-[rgb(160,160,160)] mb-2">
                          YEARS OF SERVICE <span className="text-[rgb(187,0,0)]">*</span>
                        </label>
                        <input
                          type="number"
                          name="yearsOfService"
                  ...
                  <div className="mb-6">
                    ...
                    <div>
                      <label className="block text-xs text-[rgb(160,160,160)] mb-2">
                        CURRENT SUPERVISOR NAME <span className="text-[rgb(187,0,0)]">*</span>
                      </label>
                      <input
                        type="text"
                        name="supervisor"
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-4">
                      <div>
                        <label className="block text-xs text-[rgb(160,160,160)] mb-2">
                          AVAILABILITY DATE <span className="text-[rgb(187,0,0)]">*</span>
                        </label>
                        <input
                          type="date"
                          name="availability"
                      ...
                      <div>
                        <label className="block text-xs text-[rgb(160,160,160)] mb-2">
                          REASON FOR TRANSFER REQUEST <span className="text-[rgb(187,0,0)]">*</span>
                        </label>
                        <textarea
                          name="reason"
