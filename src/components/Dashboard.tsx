        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-[rgb(230,200,80)] font-bold mt-1">RAISA-CSM-026</p>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xl font-bold text-[rgb(230,200,80)]">{avgTimeliness}/5</span>
              </div>
              <div className="w-full bg-[rgb(17,17,17)] border border-[rgb(100,100,100)] h-3">
                <div
                  className="bg-[rgb(230,200,80)] h-full shadow-[0_0_10px_rgba(230,200,80,0.5)]"
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xl font-bold text-[rgb(230,200,80)]">{avgQuality}/5</span>
              </div>
              <div className="w-full bg-[rgb(17,17,17)] border border-[rgb(100,100,100)] h-3">
                <div
                  className="bg-[rgb(230,200,80)] h-full shadow-[0_0_10px_rgba(230,200,80,0.5)]"
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xl font-bold text-[rgb(230,200,80)]">{avgProfessionalism}/5</span>
              </div>
              <div className="w-full bg-[rgb(17,17,17)] border border-[rgb(100,100,100)] h-3">
                <div
                  className="bg-[rgb(230,200,80)] h-full shadow-[0_0_10px_rgba(230,200,80,0.5)]"
            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xl font-bold text-[rgb(230,200,80)]">{avgCommunication}/5</span>
              </div>
              <div className="w-full bg-[rgb(17,17,17)] border border-[rgb(100,100,100)] h-3">
                <div
                  className="bg-[rgb(230,200,80)] h-full shadow-[0_0_10px_rgba(230,200,80,0.5)]"
