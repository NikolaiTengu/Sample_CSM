        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-[rgb(187,0,0)] font-bold mt-1">RAISA-INFO-001</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="scp-card p-6 mb-8">
          ...
          <div className="space-y-6 text-[rgb(220,220,220)]">
            <p className="text-lg leading-relaxed">
              The <span className="text-[rgb(187,0,0)] font-bold">Recordkeeping and Information Security Administration (RAISA)</span> 
            ...
            <div className="bg-[rgb(28,28,28)] border-l-4 border-[rgb(187,0,0)] p-6 my-6">
              <h3 className="text-lg font-bold text-[rgb(187,0,0)] mb-3">Core Responsibilities</h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <span className="text-[rgb(187,0,0)] text-xl mt-1">▸</span>
        ...
        <div className="scp-card p-6 mb-8">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-[rgb(100,100,100)] pl-6 py-2">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-2">1954 - Foundation</div>
            ...
            <div className="border-l-4 border-[rgb(100,100,100)] pl-6 py-2">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-2">1967 - Digital Transition</div>
              <p className="text-[rgb(220,220,220)]">
            ...
            <div className="border-l-4 border-[rgb(100,100,100)] pl-6 py-2">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-2">1983 - Global Network</div>
              <p className="text-[rgb(220,220,220)]">
            ...
            <div className="border-l-4 border-[rgb(100,100,100)] pl-6 py-2">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-2">1998 - Security Enhancement</div>
              <p className="text-[rgb(220,220,220)]">
            ...
            <div className="border-l-4 border-[rgb(100,100,100)] pl-6 py-2">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-2">2015 - Modern Era</div>
              <p className="text-[rgb(220,220,220)]">
            ...
            <div className="border-l-4 border-[rgb(187,0,0)] pl-6 py-2">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-2">2026 - Present Day</div>
              <p className="text-[rgb(220,220,220)]">
        ...
        <div className="scp-card p-6 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-5">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-3">Records & Archival Office</div>
            ...
            <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-5">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-3">Technical Office</div>
              <p className="text-[rgb(220,220,220)] text-sm">
            ...
            <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-5">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-3">Engineering Office</div>
              <p className="text-[rgb(220,220,220)] text-sm">
            ...
            <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-5">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-3">Security Office</div>
              <p className="text-[rgb(220,220,220)] text-sm">
            ...
            <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-5">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-3">Surveillance Division</div>
              <p className="text-[rgb(220,220,220)] text-sm">
            ...
            <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-5">
              <div className="text-[rgb(187,0,0)] font-bold text-lg mb-3">Special Technology Applications</div>
              <p className="text-[rgb(220,220,220)] text-sm">
