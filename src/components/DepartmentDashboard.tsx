        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-[rgb(230,200,80)] font-bold mt-1">RAISA-DIR-026</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="scp-card p-6 mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div className="lg:col-span-2">
              <div className="mb-4">
                <h3 className="text-lg font-bold text-[rgb(230,200,80)] mb-2">{departmentInfo.name}</h3>
              ...
              <div className="bg-[rgb(28,28,28)] border-l-4 border-[rgb(230,200,80)] p-4">
                <h4 className="text-sm font-bold text-[rgb(230,200,80)] mb-2">MISSION STATEMENT</h4>
            ...
            <div className="space-y-4">
              <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-4">
                ...
                <p className="text-2xl font-bold text-[rgb(230,200,80)]">{departmentInfo.established}</p>
              </div>
              
              <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-4">
                <p className="text-xs text-[rgb(160,160,160)] mb-1">TOTAL PERSONNEL</p>
                <p className="text-2xl font-bold text-[rgb(230,200,80)]">{departmentInfo.totalStaff}</p>
              ...
              <div className="bg-[rgb(28,28,28)] border border-[rgb(100,100,100)] p-4">
                ...
                <p className="text-2xl font-bold text-[rgb(230,200,80)]">{avgYearsOfService}y</p>
              </div>
            </div>
          </div>
          ...
          {/* Divisions */}
          <div className="mt-6">
            <h4 className="text-sm font-bold text-[rgb(230,200,80)] mb-3">OPERATIONAL DIVISIONS</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="scp-card p-6 text-center">
            <div className="text-4xl font-bold text-[rgb(230,200,80)] mb-2">{clearanceLevels.level5}</div>
          ...
          <div className="scp-card p-6 text-center">
            <div className="text-4xl font-bold text-[rgb(230,200,80)] mb-2">{clearanceLevels.level4}</div>
          ...
          <div className="scp-card p-6 text-center">
            <div className="text-4xl font-bold text-[rgb(230,200,80)] mb-2">{clearanceLevels.level3}</div>
              ...
              <div key={employee.id} className="scp-card p-6">
                ...
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-xs text-[rgb(230,200,80)] font-bold mt-1">{employee.id}</p>
                  </div>
                  <div className="text-right">
                    <div className="inline-block bg-[rgb(230,200,80)] text-white text-xs font-bold px-3 py-1 mb-2">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-sm text-[rgb(230,200,80)] font-bold">{employee.yearsOfService} Years</p>
                </div>
